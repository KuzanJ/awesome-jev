...
| [djascorp/jev-trade](https://github.com/djascorp/jev-trade) | Finance and trading experiments | Trading project using JEV by TypeSafe AI | Not detected | [Source](https://github.com/djascorp/jev-trade) |
| [erik-dunteman/ChatJev](https://github.com/erik-dunteman/ChatJev) | Other related projects | Turning the Jev classifier model into an autoregressive next token predictor | Not detected | [Source](https://github.com/erik-dunteman/ChatJev) |
| [gzd2032/typesafe-ai-test](https://github.com/gzd2032/typesafe-ai-test) | Demos and playgrounds | a test repo for typesafe.ai | Not detected | [Source](https://github.com/gzd2032/typesafe-ai-test) |
...
| [ndolinschi/jev-wave](https://github.com/ndolinschi/jev-wave) | Data search and document workflows | TypeSafe Jev research + 5 product specs | Not detected | [Source](https://github.com/ndolinschi/jev-wave) |
| [nsillik/jevvin-off](https://github.com/nsillik/jevvin-off) | Demos and playgrounds | Prototyping against TypeSafe's Jev System One API: a one-ticket quickstart and a Bluesky Jetstream firehose demo. | Not detected | [Source](https://github.com/nsillik/jevvin-off) |
| [nylon-memory/NylonME](https://github.com/nylon-memory/NylonME) | Agent tools and workflow control | A Memory Engine for AI Agents,Working with Jev can bring higher decision accuracy . Nylon models a memory as a woven body ... | Apache-2.0 | [Source](https://github.com/nylon-memory/NylonME) |
| [onionminionops-beep/pdoom-protocol](https://github.com/onionminionops-beep/pdoom-protocol) | Games robotics and simulations | USER + JEV: P(DOOM) PROTOCOL — co-op platform shooter where TypeSafe Jev plays alongside you | Not detected | [Source](https://github.com/onionminionops-beep/pdoom-protocol) |
| [pierangeloc/zio-typesafe-ai](https://github.com/pierangeloc/zio-typesafe-ai) | SDKs and integrations | Simple ZIO based client library for typesafe-ai | Not detected | [Source](https://github.com/pierangeloc/zio-typesafe-ai) |
| [pjt3591oo/laya-server](https://github.com/pjt3591oo/laya-server) | Productivity and domain applications | typesafe ai &gt; systemone &gt; jev | Not detected | [Source](https://github.com/pjt3591oo/laya-server) |
| [samoweb3/jev-x-posts](https://github.com/samoweb3/jev-x-posts) | Finance and trading experiments | Sortable 48-hour X post report for Jev, TypeSafe AI and Diogo Almeida, with Jev sentiment labels | Not detected | [Source](https://github.com/samoweb3/jev-x-posts) |
| [zadescoxp/Jev-Trades](https://github.com/zadescoxp/Jev-Trades) | Finance and trading experiments | Trading bot with the all new TypeSafe AI's first system one model named as Jev | Apache-2.0 | [Source](https://github.com/zadescoxp/Jev-Trades) |
